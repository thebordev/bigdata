import requests
from config import FIND_CLONE_LOGIN, FIND_CLONE_PASSWORD


class FindCloneAPI:
    def __init__(self):
        self.login = FIND_CLONE_LOGIN
        self.password = FIND_CLONE_PASSWORD
    ...
    def login(self):
        try:
            ...
            data = {'phone': self.login, 'password': self.password}
